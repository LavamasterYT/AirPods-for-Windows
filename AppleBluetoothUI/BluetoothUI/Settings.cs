...
namespace BluetoothUI
{
    class Settings
    {
        ...
        public static bool CheckIfUsingStaticText() => bool.Parse(Registry.CurrentUser.OpenSubKey("SOFTWARE\\AppleBluetoothUI").GetValue("UsingStaticText", false).ToString());
