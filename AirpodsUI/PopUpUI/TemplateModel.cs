...
namespace PopUpUI
{
    ...
    public partial class Template
    {
        public static Template FromJson(string json) => JsonConvert.DeserializeObject<Template>(json, PopUpUI.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this Template self) => JsonConvert.SerializeObject(self,PopUpUI.Converter.Settings);
    }
